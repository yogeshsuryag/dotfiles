...
$script:DotfilesConfigKeys = @(
    ...
    'DOTFILES_INSTALL_GH_AXI',
    'DOTFILES_INSTALL_CHROME_DEVTOOLS_AXI',
    'DOTFILES_INSTALL_LAVISH_AXI',
...
function Initialize-DotfilesConfigDefaults {
    ...
    Set-DotfilesDefault $Config 'DOTFILES_INSTALL_GH_AXI' '1'
    Set-DotfilesDefault $Config 'DOTFILES_INSTALL_CHROME_DEVTOOLS_AXI' '1'
    Set-DotfilesDefault $Config 'DOTFILES_INSTALL_LAVISH_AXI' '1'
...
function Assert-DotfilesConfig {
    ...
    $booleanKeys = @(
        'DOTFILES_INSTALL_SCOOP', 'DOTFILES_UPDATE_SCOOP', 'DOTFILES_INSTALL_PSMUX', 'DOTFILES_INSTALL_GH_AXI', 'DOTFILES_INSTALL_CHROME_DEVTOOLS_AXI', 'DOTFILES_INSTALL_LAVISH_AXI', 'DOTFILES_INSTALL_NO_MISTAKES', 'DOTFILES_INSTALL_GNHF',
