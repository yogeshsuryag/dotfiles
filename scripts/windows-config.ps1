...
function Assert-DotfilesConfig {
    ...
    $booleanKeys = @(
        'DOTFILES_INSTALL_SCOOP', 'DOTFILES_UPDATE_SCOOP', 'DOTFILES_INSTALL_PSMUX', 'DOTFILES_INSTALL_GH_AXI', 'DOTFILES_INSTALL_CHROME_DEVTOOLS_AXI', 'DOTFILES_INSTALL_LAVISH_AXI', 'DOTFILES_INSTALL_NO_MISTAKES',
