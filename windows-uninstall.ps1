...
$links = @(
    ...
    @{ Source = (Join-Path $RepoRoot 'home/.config/wezterm'); Target = $WeztermConfigDir },
    @{ Source = (Join-Path $RepoRoot 'home/.config/wezterm/wezterm.lua'); Target = $WeztermConfigFile },
